...
export function InfoTip({ children, width = 'w-72', align = 'left' }) {
    return (_jsxs("span", { className: "group relative inline-flex items-center", children: [_jsx("span", { "aria-label": "info", className: "ml-1 inline-flex h-3.5 w-3.5 items-center justify-center\n                   rounded-full border border-muted/40 dark:border-muted-dark/40\n                   text-[9px] font-medium text-muted dark:text-muted-dark\n                   cursor-help select-none leading-none", children: "i" }), _jsx("span", { role: "tooltip", className: `pointer-events-none invisible opacity-0
                    ...
                    transition-opacity`, children: children })] }));
}
